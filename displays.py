...
PINK = '#%02x%02x%02x' % (int(1 * 255), int(0.4 * 255), int(0.7 * 255))
AQUA = '#%02x%02x%02x' % (int(0 * 255), int(1 * 255), int(1 * 255))
ORANGE = '#%02x%02x%02x' % (int(1 * 255), int(0.4 * 255), int(0 * 255))
PURPLE = '#%02x%02x%02x' % (int(0.75 * 255), int(0.25 * 255), int(1 * 255))
BORDO = '#%02x%02x%02x' % (int(0.55 * 255), int(0 * 255), int(0 * 255))
...
class GuiDisplay(Display):
    ...
    _line_width = 10
    _dot_width = 35
    _colors = [GREY, RED, YELLOW, GREEN, BLUE, AQUA, ORANGE, PINK, PURPLE, BORDO]
    ...
    def draw_board(self, board, dots=set()):
        ...
        def flip_board(board):
            flip_bloard = np.flip(np.flip(board), 1)
            return flip_bloard

        state = flip_board(board.state)
